...
class Collision:
    ...
    def _calc_chunk_id(self, x, y, gridsize:int) -> tuple[int,int]:
        """
    ...
    def _get_chunk_id_neighbors(self, chunk_id:tuple[int,int]) -> Iterator[tuple[int,int]]:
        """
    ...
    def get_close_pairs(self, xs:Sequence, ys:Sequence, gridsize:int) -> Iterator[tuple[int,int]]:
        """
        ...
        for i, (x, y) in enumerate(zip(xs, ys)):
            own_chunk_id = self._calc_chunk_id(x, y, gridsize)
            for neighbor_id in self._get_chunk_id_neighbors(own_chunk_id):
