...
def _calc_chunk_id(x, y, gridsize:int) -> tuple[int,int]:
    """
...
def get_close_pairs(xs:Sequence, ys:Sequence, gridsize:int) -> Iterator[tuple[int,int]]:
    """
...
def loop(xs:Sequence, ys:Sequence, gridsize:int):
