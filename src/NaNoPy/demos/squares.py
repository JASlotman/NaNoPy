...
def demo() -> None:
    ...
    pen.draw_polygon_regular(50, 150, 25, 4, green, False)
    pen.draw_polygon_regular(100, 150, 25, 4, green_mid, True)
    pen.draw_polygon_regular(151, 150, 25, 4, green_mid_light, True)
    pen.draw_polygon_regular(202, 150, 25, 4, green_light, True)
    pen.draw_polygon_regular(50, 250, 25, 6, green, False)
    pen.draw_polygon_regular(100, 250, 25, 6, green_mid, True)
    pen.draw_polygon_regular(151, 250, 25, 6, green_mid_light, True)
    pen.draw_polygon_regular(202, 250, 25, 6, green_light, True)
